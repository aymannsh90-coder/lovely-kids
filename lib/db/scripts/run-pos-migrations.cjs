...
const MIGRATIONS = [
  ...
  "20260916_create_finance_foundation.sql",
  "20260916_create_delivery_company_settlements.sql",
  "20260924_create_inventory_movements.sql",
  "20260924_inventory_movements_product_set_null.sql",
];
...
async function applyMigrations(migrations) {
  ...
  if (approval !== "APPLY_POS_20260924_STOCK_CARD_FK") {
