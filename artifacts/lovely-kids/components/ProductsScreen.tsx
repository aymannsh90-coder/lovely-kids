...
const PRODUCT_CATEGORY_IMAGES = {
  all: require("../assets/images/category-cards/all.webp"),
  boysSets: require("../assets/images/category-cards/boys-sets.webp"),
  girlsSets: require("../assets/images/category-cards/girls-sets.webp"),
  babySets: require("../assets/images/category-cards/baby-sets.webp"),
  pants: require("../assets/images/category-cards/pants.webp"),
  tops: require("../assets/images/category-cards/tops.webp"),
  shorts: require("../assets/images/category-cards/shorts.webp"),
  dresses: require("../assets/images/category-cards/dresses.webp"),
  shirts: require("../assets/images/category-cards/shirts.webp"),
  babyEssentials: require("../assets/images/category-cards/baby-essentials.webp"),
  blankets: require("../assets/images/category-cards/blankets.webp"),
  tracksuits: require("../assets/images/category-cards/tracksuits.webp"),
  babyBoxSets: require("../assets/images/category-cards/baby-box-sets.webp"),
  babyOveralls: require("../assets/images/category-cards/baby-overalls.webp"),
  bathTowelsRobes: require("../assets/images/category-cards/bath-towels-robes.webp"),
  babyBags: require("../assets/images/category-cards/baby-bags.webp"),
  babyCapsBibs: require("../assets/images/category-cards/baby-caps-bibs.webp"),
  kidsWinterJackets: require("../assets/images/category-cards/kids-winter-jackets.webp"),
};
...
function getCategoryImage(label: string): any {
  ...
  if (value.includes("حرامات") || value.includes("بطانيات"))
    return PRODUCT_CATEGORY_IMAGES.blankets;

  if (
    (value.includes("افرهولات") || value.includes("افرولات")) &&
    value.includes("بيبي")
  )
  ...
  if (
    ...
    return PRODUCT_CATEGORY_IMAGES.kidsWinterJackets;
  ...
  if (
    ...
    return PRODUCT_CATEGORY_IMAGES.babyBoxSets;
